...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_Graphique_t, stringdata) + ofs \
...
QT_MOC_LITERAL(2, 32, 0) // ""
    ...
    "Graphique\0on_pushButton_clicked\0"
};
...
const QMetaObject Graphique::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_Graphique.data,
      qt_meta_data_Graphique,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *Graphique::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Graphique.stringdata))
